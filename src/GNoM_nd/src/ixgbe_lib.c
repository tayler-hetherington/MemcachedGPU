...
static bool ixgbe_set_dcb_vmdq_queues(struct ixgbe_adapter *adapter)
{
	...
	//printk("[INTEL_NIC] IXGBE_SET_DCB_VMDQ_QUEUES\n");
...
static bool ixgbe_set_dcb_queues(struct ixgbe_adapter *adapter)
{
	...
	//printk("[INTEL_NIC] IXGBE_SET_DCB_QUEUES\n");
...
static void ixgbe_set_num_queues(struct ixgbe_adapter *adapter)
{
	...
	//printk("[INTEL_NIC] IXGBE_SET_NUM_QUEUES\n");
				...
				unsigned int rxr_count, unsigned int rxr_idx)
{
    ...
    printk("[UBC_GPU_NIC]: Work limit rx: %d, tx: %d\n", adapter->rx_work_limit, adapter->tx_work_limit);
